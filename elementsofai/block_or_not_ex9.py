...
def calculateProbOfBeingABotUser(prob_of_8digits, p8_bot, pbot):
    prob8DigitsGivenBot = p8_bot * pbot
    probBotGiven8Digits = prob8DigitsGivenBot / prob_of_8digits
    print(prob8DigitsGivenBot)
    return probBotGiven8Digits
